...
import com.umutkina.findunfollowersapp.SearchActivity;
...
/**
 * Created by mac on 27/05/15.
 */
public class FollowSearchListAdapter extends BaseAdapter {
    ...
    public FollowSearchListAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tvUserFollowBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SearchActivity unfListActivity = (SearchActivity) context;
